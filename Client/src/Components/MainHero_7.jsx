...
const MainHero_7 = () => {
  return (
    <div className=" bg-[#010101] text-center flex items-start justify-center  relative h-[500px]  font-Poppins  ">
      <motion.div
        className="flex items-center  absolute top-[-205%] right-[3%] max-lg:right-[0]  "
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <img
          ...
          className="w-[600px] max-lg:w-96 transform scale-x-|-1]   "
        />
      </motion.div>
      <div className="flex flex-col -mt-48  gap-20  font-Poppins  ">
        <motion.p
