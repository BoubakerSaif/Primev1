...
const RPGuide = () => {
  return (
    <div className="bg-[#010101] h-auto text-white font-Poppins">
      <main className="flex flex-col gap-28">
        <div className="text-center gap-8 flex flex-col">
          ...
          <h2 className="text-lg lg:w-[800px] mx-auto  ">
            Welcome to Prime Roleplay! We’re thrilled to have you here! To make
            sure everyone has a great time, reading the community guidelines and
            following them is mandatory, violating these terms will result in a
            permanent suspension from the community.
          </h2>
        </div>
        <div className="flex  ">
          <div className=" flex flex-col  gap-4 w-fit  text-sm     ">
            <div className="flex items-center  lg:w-[1000px] group hover:cursor-pointer ">
              ...
              <p className="flex flex-col w-auto ">
                ...
                Everything should stay within the roleplay based on common logic
                relative to the character's status, wealth, and social position
                in the community.
                <span>
                  Example: A burger worker eligible for dirty business can rob a
                  shop to earn extra money, but the burger owner, due to their
                  wealth and social status, should not engage in street-level
                  crimes. Instead, they could participate in high-stakes
                  operations like money laundering
                </span>
              </p>
            </div>
            <div className="flex items-center  lg:w-[1000px] group hover:cursor-pointer">
              ...
              <p className="flex flex-col w-auto ">
                ...
                <span>
                  Example: A burger worker should not rob a wallet from another
                  player without a valid reason due to their social and economic
                  status. Conversely, a gang member might rob someone in their
                  territory to assert dominance or send a message, but this
                  should always be justified with a creative and valid reason.
                </span>
              </p>
            </div>
            <div className="flex items-center  lg:w-[1000px] group hover:cursor-pointer">
            ...
            <div className="flex items-center  lg:w-[1000px] group hover:cursor-pointer">
              ...
              <p className="flex flex-col w-auto ">
                ...
                <span>
                  ...
                  out-of-character (OOC) actions, meta-gaming, or power-gaming,
                  will result in a ban. Roleplay should be consistent and
                  uninterrupted by OOC elements.
                </span>
              </p>
            </div>
            <div className="flex items-center  lg:w-[1000px] group hover:cursor-pointer">
              ...
              <p className="flex flex-col w-auto ">
                ...
                <span>
                  ...
                  instance, a kidnapper cannot force a hostage to commit suicide
                  unless it is contextually justified and the hostage's
                  situation reflects this possibility. Law enforcement cannot
                  force a player to become a criminal without clear evidence.
                </span>
              </p>
            </div>
            <div className="flex items-center  lg:w-[1000px] group hover:cursor-pointer">
              ...
              <p className="flex flex-col w-auto ">
                ...
                <span>
                  ...
                  interaction. The scene should involve negotiation or exchange,
                  rather than simply taking without giving.
                </span>
              </p>
            </div>
            <div className="flex items-center  lg:w-[1000px] group hover:cursor-pointer">
              ...
              <p className="flex flex-col w-auto ">
                ...
                When deciding to involve yourself in an ongoing scene, ensure it
                is logical and well-planned.
                <span>
                  Rule: Intervening in an ongoing scenes requires adherence to
                  three major rules: Logic RP (ensure your involvement makes
                  sense), Reason RP (have a valid reason for interference), and
                  Fear RP (acknowledge the risks involved). If these conditions
                  are not met, avoid intervening. This rule aims to replace
                  traditional third-party interference with more thoughtful
                  engagement.
                </span>
              </p>
            </div>
            <div className="flex items-center  lg:w-[1000px] group hover:cursor-pointer">
              ...
              <p className="flex flex-col w-auto ">
                ...
                <span>
                  ...
                  scenarios where your character acts without regard for risk or
                  consequences, as this can lead to power gaming or breaking the
                  roleplay immersion.
                </span>
              </p>
            </div>
            <div className="flex items-center  lg:w-[1000px] group hover:cursor-pointer">
              ...
              <p className="flex flex-col w-auto ">
                ...
                This is a reminder that roleplay has no inherent limits if logic
                and reason are respected.
                <span>
            ...
            <div className="flex items-center  lg:w-[1000px] group hover:cursor-pointer">
              ...
              <p className="flex flex-col w-auto ">
                ...
                <span>
                  ...
                  thoughtfully with your roleplay. You also need to evolve your
                  character story and create a meaningful and a creative
                  storyline for it
                </span>
              </p>
            </div>
